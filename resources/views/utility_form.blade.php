        ...
        <div class="container">
            <div class="row">
                <div class="booking-form">
                    ...
                    <form action="{{url('store-utility')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <span class="form-label">Commodity Id</span>
                                    <input class="form-control" type="text" name="commodity_id" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="commodity_name"  required>
                                    </div>

                                <div class="form-group">
                                    <span class="form-label">commodity price</span>
                                    <input class="form-control" type="text" name="commodity_price"  required>
                                </div>

                                <div class="form-group">
                                    <span class="form-label">commodity quantity</span>
                                    <input class="form-control" type="text" name="commodity_quantity"  required>
                                </div>
